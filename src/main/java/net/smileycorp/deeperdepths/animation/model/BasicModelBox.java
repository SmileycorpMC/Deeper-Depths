package net.smileycorp.deeperdepths.animation.model;
...
public class BasicModelBox extends ModelBox {
    ...
    public BasicModelBox(BasicModelPart renderer, int texU, int texV, float x, float y, float z, int dx, int dy, int dz, float delta) {
        this(renderer, texU, texV, x, y, z, dx, dy, dz, delta, renderer.mirror);
    }


    public BasicModelBox(BasicModelPart renderer, int texU, int texV, float x, float y, float z, int dx, int dy, int dz, float delta, boolean mirror)
    {
    ...
    public BasicModelBox setBoxName(String name)
    {
        this.boxName = name;
        return this;
    }
