...
public class DeeperDepthsLootTables
{
    ...
    public static final ResourceLocation TRIAL_SPAWNER_KEY = new ResourceLocation(Constants.MODID, "trial_spawner");
    public static final ResourceLocation TRIAL_SPAWNER_KEY_OMINOUS = new ResourceLocation(Constants.MODID, "ominous_trial_spawner");
