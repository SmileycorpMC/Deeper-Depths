...
public interface ICopperBlock {
    ...
    default void scrape(EntityLivingBase entity, World world, ItemStack stack, IBlockState state, BlockPos pos) {
    ...
    default void wax(EntityLivingBase entity, World world, ItemStack stack, IBlockState state, BlockPos pos) {
