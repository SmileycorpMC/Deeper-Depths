...
import com.deeperdepths.common.blocks.BlockCutCopperSlab;
...
public class ItemCopperSlab<T extends BlockCutCopperSlab> extends ItemDDSlab<T> implements ICopperItem {
    
    public ItemCopperSlab(T block) {
        super(block);
    }
